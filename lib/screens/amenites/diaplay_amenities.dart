            ...
            TextButton(
              ...
              onPressed: () async{
                ...
                final success = await data.postAmenities(
                  ...
                  [], // No amenities to add or update
                  [amenityToRemove], // The amenity to remove
                );
                // data.postAmenities(data.BusinessData!.businessUid, [] ,[]);
                if (success) {
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(content: Text('Amenity deleted successfully')),
                  );
                } else {
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(content: Text('Failed to delete amenity')),
                  );
